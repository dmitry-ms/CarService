        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEngine = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    EnginePowerKW = table.Column<int>(type: "int", nullable: false),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EngineVolumeSquareCentimeter = table.Column<int>(type: "int", nullable: true),
                    DEF = table.Column<bool>(type: "bit", nullable: true),
                    NumberCylinders = table.Column<int>(type: "int", nullable: true),
                    NumberValves = table.Column<int>(type: "int", nullable: true),
                    BatteryCapacity = table.Column<int>(type: "int", nullable: true),
                    PetrolEngine_EngineVolumeSquareCentimeter = table.Column<int>(type: "int", nullable: true),
                    PetrolEngine_NumberCylinders = table.Column<int>(type: "int", nullable: true),
                    PetrolEngine_NumberValves = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    DriveUnit = table.Column<int>(type: "int", nullable: false),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AutomaticTransmission_NumberOfGears = table.Column<int>(type: "int", nullable: true),
                    MechanicTransmission_NumberOfGears = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientCars_Person_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientCars_Vehicles_VehicleId",
